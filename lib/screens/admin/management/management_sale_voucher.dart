...
class ManagementSaleVoucher extends StatefulWidget {
  const ManagementSaleVoucher({super.key});

  @override
  State<ManagementSaleVoucher> createState() => _ManagementSaleVoucherState();
}

class _ManagementSaleVoucherState extends State<ManagementSaleVoucher> {
  ...
  void initState() {
    super.initState();
    _testCarsFuture =
        Provider.of<MainViewModel>(context, listen: false).getTestCarsByType(3);
  }
