...
class ManagementTestCar extends StatefulWidget {
  const ManagementTestCar({super.key});

  @override
  State<ManagementTestCar> createState() => _ManagementTestCarState();
}

class _ManagementTestCarState extends State<ManagementTestCar> {
  ...
  void initState() {
    super.initState();
    _testCarsFuture =
        Provider.of<MainViewModel>(context, listen: false).getTestCarsByType(0);
  }
