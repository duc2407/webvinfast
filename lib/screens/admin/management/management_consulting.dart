...
class ManagementConsulting extends StatefulWidget {
  const ManagementConsulting({super.key});

  @override
  State<ManagementConsulting> createState() => _ManagementConsultingState();
}
...
class _ManagementConsultingState extends State<ManagementConsulting> {
  ...
  void initState() {
    super.initState();
    _testCarsFuture =
        Provider.of<MainViewModel>(context, listen: false).getTestCarsByType(1);
  }
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: const Color.fromARGB(255, 70, 75, 215),
                    ...
                    child: SizedBox(
                      ...
                      child: DataTable(
                        ...
                        headingRowColor: MaterialStateProperty.all(
                            const Color.fromARGB(124, 68, 74, 237)),
